...
import Massatge from './actions/massatge'
import Jacuzzi from './actions/jacuzzi'
import Exfoliant from './actions/exfoliant'
...
export const routes = [
  ...
  { path: 'massatge', payload: 'massatge', action: Massatge },
  { path: 'jacuzzi', payload: 'jacuzzi', action: Jacuzzi },
  { path: 'exfoliant', payload: 'exfoliant', action: Exfoliant },
  {
  ...
  { path: 'not_found', type: /.*/, action: Spa }
